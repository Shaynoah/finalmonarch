...
const GroupMortgageProtection = () => {
  return (
    <div className="group-mortgage-protection-page">
      {/* Hero Section */}
      <section className="group-mortgage-protection-hero">
        <div className="group-mortgage-protection-hero-content">
          ...
          <p className="group-mortgage-protection-subtitle">
            Comprehensive protection for mortgage loans ensuring property remains with families
          </p>
        </div>
      </section>

      {/* Main Content Section */}
      <section className="group-mortgage-protection-content-section">
        <div className="container">
          <div className="group-mortgage-protection-info-card">
...
export default GroupMortgageProtection
