        ...
        <div className="container">
          ...
          <div className="insurance-form-wrapper" style={{ marginTop: '3rem' }}>
            <div className="insurance-form-image">
              <img loading="lazy" src="https://res.cloudinary.com/diozv0xm2/image/upload/q_auto/f_auto/v1776343488/cartage2-copy-0_p5onxn.png" alt="Freight truck covered by general cartage insurance in Kenya" />
            </div>
