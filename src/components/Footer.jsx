...
const Footer = () => {
  ...
  const socialLinks = [
    { 
      href: 'https://www.facebook.com/share/1C4rt2eRH6/', 
      label: 'Facebook',
      icon: (
    ...
    { 
      href: 'https://www.linkedin.com/company/the-monarch-insuranc/', 
      label: 'LinkedIn',
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor">
    ...
    { 
      href: 'https://www.instagram.com/themonarchinsurancecompany?igsh=c3ZkZ2puZHU2cXo2', 
      label: 'Instagram',
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor">
              ...
              {insuranceTypes.map((item, index) => (
                <li key={index}>
                  {item.href.startsWith('/') ? (
                    <Link to={item.href} onClick={() => window.scrollTo({ top: 0, behavior: 'instant' })}>{item.label}</Link>
                  ) : (
              ...
              {services.map((service, index) => (
                <li key={index}>
                  {service.href.startsWith('/') ? (
                    <Link to={service.href} onClick={() => window.scrollTo({ top: 0, behavior: 'instant' })}>{service.label}</Link>
                  ) : (
                    <a 
                      href={service.href} 
          ...
          <div className="footer-section">
            ...
            <div className="footer-reach-us">
              ...
              <div className="reach-item">
                ...
                <div className="reach-content">
                  <Link to="/branches" onClick={() => window.scrollTo({ top: 0, behavior: 'instant' })}>Our Branches</Link>
                </div>
              </div>
            </div>
          </div>
